...
# Bins unique bam reads by region name/class. For example, if a unique read is associated with rpt class x and y, the x and y bins get iterated by 1. If a unique read is associated with 2 elements that are both of class x, x gets iterated by 2.
