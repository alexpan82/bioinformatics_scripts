...
labels = venn.get_labels([set_list[0], set_list[1], set_list[2], set_list[3]],fill=['number','number'])
fig, ax = venn.venn4(labels, names = (argv[2], argv[3], argv[4], argv[5]))
plt.tight_layout()
