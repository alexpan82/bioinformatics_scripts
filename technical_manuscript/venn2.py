...
# Overlap
print(len(set_list[0]), len(set_list[1]))
...
figure = venn2_unweighted(subsets = (len(set_list[0])-intersect, len(set_list[1])-intersect, intersect), 
...
intersect_label = "(%s%%/\n%s%%)" % (round(100.*sharedcount[0]/totals[0], 0), round(100.*sharedcount[1]/totals[1], 0))
