# Calculate positional and sequence duplication in bam
import pysam
import argparse
import pybedtools
...
def main(args):
	...
	if option == 'pos':
		...
		# Assumes paired reads in bam file have the same name
		...
		# Add "chr\tstart\tstop,chr\tstart\stop" to uniqset
		...
		# Output unique and duplicated positions to bed files
